...
import { Link, Routes, useRouter, Image } from "blitz"
...
export default function NavbarLogedOut() {
  const router = useRouter()
  return (
    <Disclosure as="nav" className="bg-gray-100 border-slate-200 border-b-2 py-3 ">
      {({ open }) => (
        <>
