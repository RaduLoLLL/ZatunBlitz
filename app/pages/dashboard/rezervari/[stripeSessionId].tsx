...
const Rezervare: BlitzPage = () => {
  ...
  "
        ...
        "
                  >
                    <p className="text-gray-400 ml-4">
                      Taxa Foisor Mic Zatun 1 - 8 persoane ( Nr. {booking.foisormic.join(", ")} )
                    </p>
                    <p className="text-black mr-4"> {booking.foisormic.length} x 120 Lei</p>
                  </div>
                ) : (
                  <div></div>
                )}
        ...
        "
                  >
                    <p className="text-gray-400 ml-4">
                      Taxa Foisor Mare Zatun 1 - 20 persoane ( Nr. {booking.foisormare.join(", ")} )
                    </p>
                    <p className="text-black mr-4"> {booking.foisormare.length} x 300 Lei</p>
                  </div>
                ) : (
                  <div></div>
                )}
        ...
        "
                  >
                    <p className="text-gray-400 ml-4">
                      Taxa Foisor Mic Zatun 2 - 14 persoane ( Nr. {booking.foisormic2.join(", ")} )
                    </p>
                    <p className="text-black mr-4"> {booking.foisormic2.length} x 210 Lei</p>
                  </div>
                ) : (
                  <div></div>
                )}
        ...
        "
                  >
                    <p className="text-gray-400 ml-4">
                      Taxa Foisor Mare Zatun 2 - 30 persoane ( Nr. {booking.foisormare2.join(", ")}{" "}
                      )
                    </p>
                    <p className="text-black mr-4"> {booking.foisormare2.length} x 450 Lei</p>
                  </div>
                ) : (
                  <div></div>
                )}
