...
function Cookies() {
  return (
    <>
      <div className="flex flex-col justify-center mx-12 mt-12">
        <h1 className="text-xl font-bold">Cookie Policy for Balta Zatun</h1>

        <p>This is the Cookie Policy for Balta Zatun, accessible from baltazatun.ro</p>
        ...
        <div className="mt-6">
          ...
          <ul>
            <li>
              <p className="font-medium mt-2">Account related cookies</p>
              <p>
            ...
            <li>
              <p className="font-medium mt-2">Login related cookies</p>
              <p>
        ...
        <ul className="mb-12">
          <li>Email: contact@baltazatun.ro</li>
        </ul>
      </div>
    </>
  )
...
Cookies.getLayout = (page) => <Layout title="Cookies">{page}</Layout>
